...
$(function(){
	$.fn.popup=function(options){
	    ...
	    var htmlStr="<div class='shadow'></div><div class='popup' style='display:block;'><p class='popup-p'>"+options.text
	    		+"</p><div class='popup-btn'><a href='javascript:;'  btn-triggle='expandUp' class='popup-gay'>取消</a><a target='"+options.urlblank+"' href='"+options.url+"' btn-triggle='expandUp' class='psure'>"+options.aText+"</a><span onclick=window.open('"+
