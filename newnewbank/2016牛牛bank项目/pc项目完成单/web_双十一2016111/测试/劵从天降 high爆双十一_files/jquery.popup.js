$(function(){
	$.fn.popup=function(options){
		...
		var $this=$(this);
	    var con="<div class='shadow3'></div><div class='popup' style='display:block;'><p class='popup-p'>"+options.text+"</p><div class='popup-btn'><a target='"+options.urlblank+"' href='"+options.url+"' btn-triggle='expandUp' class='psure'>"+options.aText+"</a><a href='javascript:;'' btn-triggle='expandUp' class='popup-gay'>取消</a><span onclick=window.open('"+options.spantextSelf+"') class='plink'>"+options.spantext+"</span></div></div>";
		$this.append(con);
